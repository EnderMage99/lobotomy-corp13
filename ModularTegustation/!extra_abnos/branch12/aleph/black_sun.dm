/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar
	name = "Altar of the Black Sun"
	desc = "A small altar. Inscribed on the side is the phrase ''Memento Mori''."
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/Initialize()
	. = ..()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/Life()
	. = ..()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/StageChange()
	stage+=1
	switch(stage)
		if(1)
			Stage1()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/Stage1()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/Stage2()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/Stage3()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/Stage4()
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/RoundEnd()
	if(SSlobotomy_corp.next_ordeal_level > 4)	//Past Midnight
		for(var/mob/living/carbon/human/L in GLOB.player_list)
			L.adjust_attribute_buff(FORTITUDE_ATTRIBUTE, -25)
			L.adjust_attribute_buff(PRUDENCE_ATTRIBUTE, -25)
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/proc/on_mob_death(datum/source, mob/living/died, gibbed)
	SIGNAL_HANDLER
	if(!ishuman(died))
		return FALSE
	if(died.z != z)
...
/mob/living/simple_animal/hostile/abnormality/branch12/black_sunaltar/AttemptWork(mob/living/carbon/human/user, work_type, pe, work_time)
